                  ...
                  <div className="relative flex gap-x-3 text-[#6e767d]">
                    ...
                    <div>
                      <div className="group inline-block">
                        <h1 className="inline-block text-[15px] font-bold text-secondary group-hover:underline sm:text-base">
                          {post?.username}
                        </h1>
                        <span className="sm:text=[15px] ml-1.5 text-sm">
                          @{post?.tag} &bull;
                        </span>
                      </div>
                  ...
                  <div className="mt-7 flex space-x-3">
                    ...
                    <div className="mt-2 flex-grow">
                      <textarea
                        ...
                        rows="2"
                        className="min-h-[80px] w-full bg-transparent text-lg tracking-wide text-secondary placeholder-gray-500 outline-none"
                      />
